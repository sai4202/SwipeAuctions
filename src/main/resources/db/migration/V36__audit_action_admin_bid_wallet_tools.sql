-- Adds BID_AMOUNT_MODIFIED/BIDDER_DISQUALIFIED/BIDDER_REINSTATED/WALLET_ADJUSTED to
-- admin_audit_log's action check constraint (V23/V27/V29/V33) — same fix pattern as those, this
-- time for the new admin bid-edit/disqualify/wallet-adjustment tools.
...
alter table admin_audit_log add constraint admin_audit_log_action_check check (action in (
    ...
    'BID_AMOUNT_MODIFIED','BIDDER_DISQUALIFIED','BIDDER_REINSTATED','WALLET_ADJUSTED'
));
