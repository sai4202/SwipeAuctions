-- Adds AUCTION_WIN_APPROVED/AUCTION_WIN_REJECTED to admin_audit_log's action check constraint
-- (V23/V27/V29/V33/V36) — same fix pattern as those, this time for the win approve/reject tools.
...
alter table admin_audit_log add constraint admin_audit_log_action_check check (action in (
    ...
    'AUCTION_WIN_APPROVED','AUCTION_WIN_REJECTED'
));
